...
class MoneyToStrTest extends FunSuite with BeforeAndAfter {
    val V_12L = 12;
    val V_123L = 123;
    val V_11D : Double = 11;
    val V_12D : Double = 12;
    ...
    test("main") {
        MoneyToStr.main(Array())
        MoneyToStr.main(Array("--amount=123.25", "--language=rus", "--currency=rur", "--pennies=text"))
    }
}
